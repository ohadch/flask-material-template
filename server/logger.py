...
from server.settings import LOGS_FOLDER
...
errors_file_handler = logging.FileHandler(os.path.join(LOGS_FOLDER, "errors.log"))
all_logs_file_handler = logging.FileHandler(os.path.join(LOGS_FOLDER, "all.log"))
